    ...
    <script>
        $(function(){
            ...
            $.extend($.validator.messages,{
                required: "<span style= >这是必填字段</span>",
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/px/login" method="post" class="login-form" id="loginForm">
                            <span id="msgDiv"></span>
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" class="captchaImage" src="${path}/px/yan">
                                <input minlength="4" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="test" name="ucode" id="form-code">
                            </div>
